...
(function() {
  ...
  module.exports = emport = function(targetFilename, options, callback) {
    ...
    return async.forEachSeries(basePaths, function(basePath, cb) {
      ...
      var contents, contentsInOrder, dependencies, exportVar, exports, filename, filenamesInOrder, importVar, importsAndExports, _i, _len, _ref, _ref1;
      if (err != null) {
        return callback(err);
      }
      if (options.map != null) {
      ...
      for (filename in emportMap) {
        ...
        _ref1 = importsAndExports.exports;
      ...
      for (filename in emportMap) {
        ...
        dependencies[filename] = (function() {
          ...
          _ref2 = importsAndExports.imports;
          _results = [];
          for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
            importVar = _ref2[_j];
            _results.push((function() {
              if ((_ref3 = exports[importVar]) != null) {
                return _ref3;
              } else {
      ...
      contentsInOrder = (function() {
        ...
        _results = [];
        for (_j = 0, _len1 = filenamesInOrder.length; _j < _len1; _j++) {
  ...
  resolveDeps = function(filename, depsMap, resolvedDeps) {
    ...
    for (_i = 0, _len = depFilenames.length; _i < _len; _i++) {
      ...
      if (!(__indexOf.call(resolvedDeps, depFilename) < 0)) {
        continue;
      }
